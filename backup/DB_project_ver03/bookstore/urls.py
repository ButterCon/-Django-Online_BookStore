...
urlpatterns = [
    ...
    path('<str:name>/<int:book_id>/order/', views.orderPage, name='order'),
    ...
    path('<str:name>/<int:BookOrder_id>/<int:BookSB_id>/couponselect/', views.couponselectPage, name='couponselect'),    #주문->쿠폰
